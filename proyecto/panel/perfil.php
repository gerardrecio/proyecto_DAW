            ...
            <div class="col-sm-6 col-lg-4">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card text-center">
                        <div class="card-header">
                            <strong class="card-title">Datos de la cuenta</strong>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <label for="inputPassword" class="col-sm-12 col-form-label text-center">Esta opcion <strong>borrara todos los archivos relacionados con esta cuenta</strong>, haciendo imposible su descarga. Los <strong>archivos seran irrecuperables y no podran volver a descargarse</strong></label>
                            </div>
                            <button type="button" style="color: White;" class="btn col-sm-4 bg-flat-color-4 mr-3 rounded xborrado">Borrar Archivos</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card text-center">
                        <div class="card-header">
                            <strong class="card-title">Claves</strong>
                        </div>
                        <div class="card-body">
                            <div class="form-group row">
                                <label for="inputPassword" class="col-sm-12 col-form-label text-center">Esta opcion <strong>reiniciara todas las claves relacionadas con esta cuenta</strong>, haciendo imposible la <strong>descarga de archivos privados hasta que pases las nuevas claves</strong></label>
                            </div>
                            <button type="button" style="color: White;" class="btn col-sm-4 bg-flat-color-3 mr-3 rounded xreinicializado">Reinicializar Claves</button>
                        </div>
                    </div>
                </div>
